...
<div class="content-wrapper">
                ...
                <div class="card-body">
                    <table id="example" class="display table table-stipped table-bordered table-hover" style="width:100%">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($list_perkebunan as $key => $value) {
                                echo '
                                    <tr>
                                        <td>' . $no++ . '</td>
                                        ...
                                        <td>' . $value['tahun'] . '</td>
                                        <td>
                                            <a href="' . base_url('data/perkebunan_view?id=' . $value['id_perkebunan']) . '" class="btn btn-info view" role="button"><i class="fas fa-eye fa-sm"></i></a>
                                            <a data-id="' . $value['id_perkebunan'] . '" href="#" class="btn btn-warning edit" role="button" data-toggle="modal" data-target="#exampleModalScrollable"><i class="fas fa-edit fa-sm"></i></a>
                                            <a data-id="' . $value['id_perkebunan'] . '" class="btn btn-danger hapus" href="#" role="button"><i class="fas fa-trash fa-sm fa-fw"></i></a>
                                        </td>
                                    </tr>
                                ';
                            }
    ...
    <script>
        ...
        var nama_table = "perkebunan";
        var id_table = "id_perkebunan";
