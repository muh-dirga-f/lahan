...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Detail Perikanan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                </div><!-- /.col -->
            </div><!-- /.row -->
            ...
            <div class="card card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php foreach ($list_perikanan as $key => $value) {
                            echo '
                                <div class="form-group" id="input-id">
                                    <label for="id" class="col-form-label bmd-label-static">ID</label>
                                    <input id="id" type="text" class="form-control" readonly="" value="' . $value['id_perikanan'] . '">
                                </div>
                        ...
                        <table id="example" class="display table table-stipped table-bordered table-hover" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($list_perikanan_data as $key => $value) {
                                    echo '
                                    <tr>
                                        <td>' . $no++ . '</td>
                                        <td>' . $value['nama'] . '</td>
                                        ...
                                        <td><a name="delete" data-id="' . $value['id_perikanan_data'] . '" class="btn btn-danger hapus" href="#" role="button"><i class="fas fa-trash fa-sm fa-fw"></i> Hapus</a></td>
                                    </tr>
                                ';
                                }
                                ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="<?= base_url('data/perikanan_add?id=' . $id) ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                    </div>
                </div>
            </div>
            <!-- /.card -->
    ...
    <script>
        ...
        var nama_table = "perikanan_data";
        var id_table = "id_perikanan_data";
        ...
        function initMap() {
            ...
            const array_points = <?= json_encode($list_perikanan_data) ?>;
